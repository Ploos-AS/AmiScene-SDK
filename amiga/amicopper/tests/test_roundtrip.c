...
int main(void){const char *cases[]={"MOVE COLOR00,$000f","MOVE 0x180,0x0abc","WAIT 44,0","WAIT 44,2","WAIT 100,40,63,126,0","SKIP 120,80,85,170,1","END",0};int i;for(i=0;cases[i];i++)if(!check(cases[i]))return 1;puts("AmiCopper parser/formatter round-trip PASS");return 0;}
