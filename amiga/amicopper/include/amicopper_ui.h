...
struct AmiCopperUI { void *window; int running; struct AmiCopperInstruction selected; struct AmiCopperDocument *document; char edit[96]; unsigned int edit_len; int editing; };
