import unittest
from host.amiscene.copper import parse,validate,diagnose,emit_asm,register
class CopperSourceTests(unittest.TestCase):
 ...
 def test_missing_end(self):self.assertIn("END",validate(parse("MOVE COLOR00,$000"))[0])
